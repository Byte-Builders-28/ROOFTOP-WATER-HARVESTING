...
def simulate_system_annual(
    ...
    """Simulate rainwater harvesting + groundwater recharge using annual average data."""
    ...
    # Initialize tank and groundwater
    tank_level = rain_collected
    ...
    if tank_level >= demand_total:
        ...
        if gw_level >= demand_left:
            ...
            unmet = demand_left - gw_level
            gw_level = 0
            reliability = total_supply / demand_total  # fraction met

    return total_supply, demand_total, reliability, unmet, gw_level
